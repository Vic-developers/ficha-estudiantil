-- ============================================================
-- Ficha Estudiantil - Migración 0006: Fix alta de usuarios
-- auth.admin.create_user no es invocable vía PostgREST
-- (cross-database references). Se usa insert directo en
-- auth.users + auth.identities con password cifrada (bcrypt).
-- ============================================================
